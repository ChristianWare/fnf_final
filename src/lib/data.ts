...
export const founderPoints = [
  { id: 1, text: "Your site is a revenue system, not a portfolio piece." },
  { id: 2, text: "We design a 60-second path: service → pro → time → pay." },
  {
    id: 3,
    text: "Deposits + reminders (SMS/email) to cut no-shows and last-minute cancellations.",
  },
  {
    id: 4,
    text: "We track the metrics that matter: booking completion rate, show rate, prepaid %, rebooking, membership mix, LTV/CAC payback.",
  },
  {
    id: 5,
    text: "You own the relationship and the data; we integrate your stack (Stripe/Square, calendars, Twilio, Zapier, PMS/CRM).",
  },
  {
    id: 6,
    text: "Predictable delivery: clear scope, single point of contact, launch in ~3–5 weeks.",
  },
] as const;
